class DemoController < ApplicationController
  ...
  def upload_images
    ...
    @uploads[:dog] = Cloudinary::Utils.cloudinary_url("dog.jpg", :width=>500,:crop => :scale, :secure=>true)
    @uploads[:faces] = Cloudinary::Utils.cloudinary_url("faces.jpeg", :width=>500, :crop => :scale,:secure=>true)
    @uploads[:logo] = Cloudinary::Utils.cloudinary_url("logo.png", :width => 500,:crop => :scale, :secure=>true)
    @uploads[:video] = Cloudinary::Utils.cloudinary_url("video", :secure=>true, :resource_type=>:video)
