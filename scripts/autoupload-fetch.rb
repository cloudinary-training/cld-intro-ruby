...
# puts jj Cloudinary::Utils.cloudinary_url("https://cdn.pixabay.com/photo/2015/03/26/09/39/cupcakes-690040__480.jpg", type: "fetch")
...
# puts jj Cloudinary::Utils.cloudinary_url("remote-media/video/snowboarding", {resource_type: "video",
#   transformation:{width: 300, crop: "scale"}})

# puts jj Cloudinary::Utils.cloudinary_url("remote-media/images/dolphin", 
#   {transformation:{width: 300, crop: "scale"}})

puts jj Cloudinary::Utils.cloudinary_url("remote-media/raw/data.json", resource_type: "raw")
